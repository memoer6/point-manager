...
import com.memoer6.pointreader4.dagger.PointReader;
...
public class MainActivity extends AppCompatActivity implements Presenter.Service<User>  {
    ...
    //@Inject: Basically with this annotation we request dependencies. In other words, you use it
    // to tell Dagger that the annotated class or field wants to participate in dependency
    // injection. Thus, Dagger will construct instances of this annotated classes and satisfy
    // their dependencies.
    @Inject
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Inject Presenter
        ((PointReader) getApplication()).getDependencyComponent().inject(this);
    ...
    public void showUserData() {
        ...
        mPresenter.readUserData(this, mUserId,
